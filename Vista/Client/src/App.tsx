        ...
        <div className="flex flex-col min-h-screen bg-bg text-text">
          ...
          <main className="flex-grow px-6 py-10">
            <Routes>
              ...
              <Route path="/campanas" element={<PrivateRoute><Campanas /></PrivateRoute>} />
              <Route path="/clientes" element={<PrivateRoute><Clientes /></PrivateRoute>} />
              <Route path="/conversiones" element={<PrivateRoute><Conversiones /></PrivateRoute>} />
              ...
              <Route path="/plataformas" element={<PrivateRoute><Plataformas /></PrivateRoute>} />
              <Route path="/reportes" element={<PrivateRoute><Reportes /></PrivateRoute>} />
              <Route path="/segmentos" element={<PrivateRoute><Segmentos /></PrivateRoute>} />
